...
import { checkIfWalletIsConnect, connect } from "../redux/blockchain/blockchainActions";
  ...
  return (
    <s.Screen>
      <s.Container
        ...
        ai={"center"}
        jc={"center"}
        style={{ padding: 24, backgroundColor: "#f7f9fb" }}
        image={CONFIG.SHOW_BACKGROUND ? "/config/images/bg.png" : null}
      >
        <StyledLogo alt={"logo"} src={"/config/images/logo.png"} />
        <s.SpacerXSmall />
        <div style={{ height: 32, backgroundColor: '#5ce1e6' }}>
          {blockchain.smartContract && (
            <s.TextTitle style={{ paddingRight: 4, paddingLeft: 4 }}>
